...
import com.inonu.stokmaliyet.Entity.TicketSalesDetail;
...
public interface TicketSalesDetailRepository extends JpaRepository<TicketSalesDetail, Long> {
    ...
    // Belirli bir tarih için kaç kişilik yemek yapıldığını getir (MAX kullanarak
    // aynı gün için aynı değeri döndürür)
